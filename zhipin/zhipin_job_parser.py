...
# TODO：there are 5 or 6 'job-sec' blocks, need to fix this bug.
# def job_parser(file='./raw_data/page/0c1e188662611fa71nN62Nq1GFM~.html'):
def job_parser(file='./raw_data/page/4e075087912ee2141HB529W6EVU~.html'):
    ...
    # job location
    busi_info_div = job_div[5]
    location = busi_info_div.find('div', attrs={'class': 'location-address'})
    print(location)
